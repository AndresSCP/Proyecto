...
<body>
    ...
    <div class="mask d-flex align-items-center h-100 gradient-custom-3" id="backgroundregistro">
      <div class="container h-100">
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="card" style="border-radius: 15px;">
              <div class="card-body p-5">
                <h2 class="text-uppercase text-center mb-5" id="TituloRegistro">Crea una cuenta</h2>
                ...
                <form name="Formulario" onsubmit="return validate_form()">
                  ...
                  <div class="form-outline mb-4">
                    <label class="form-label" for="Password" id="labelpassword">Contraseña</label>
                    <input type="password" id="Password" class="form-control form-control-lg" />
                  </div>
  
                  <div class="form-outline mb-4">
                    <label class="form-label" for="RPassword" id="labelRpassword">Repite tu contraseña</label>
                    <input type="password" id="RPassword" class="form-control form-control-lg" />
                  </div>
  
                  <div class="form-check d-flex justify-content-center mb-5">
                    <input class="form-check-input me-2" type="checkbox" value="" id="cajacheckbox" />
                  ...
                  <div class="d-flex justify-content-center">
                    <button type="button" class="btn btn-success btn-block btn-lg gradient-custom-4" onclick="validateForm()" id="confirmar">Registro</button>
                  </div>
  
                  <p class="text-center text-muted mt-5 mb-0">Ya tienes una cuenta? <a href="index.jsp"
